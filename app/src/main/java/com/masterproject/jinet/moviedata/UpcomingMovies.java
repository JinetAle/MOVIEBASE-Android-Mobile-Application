...
public class UpcomingMovies extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        swipeContainer.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                initViews();
                Toast.makeText(UpcomingMovies.this, "Movies Refreshed", Toast.LENGTH_SHORT).show();
            }
        });
    }
        ...
        try{
            ...
            call.enqueue(new Callback<MoviesResponse>() {
                ...
                public void onFailure(Call<MoviesResponse> call, Throwable t) {
                    ...
                    Toast.makeText(UpcomingMovies.this, "Error Fetching Data!", Toast.LENGTH_SHORT).show();
