...
public class TopRatedMovies extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        swipeContainer.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                initViews();
                Toast.makeText(TopRatedMovies.this, "Movies Refreshed", Toast.LENGTH_SHORT).show();
            }
        });
    }
        ...
        try{
            ...
            call.enqueue(new Callback<MoviesResponse>() {
                ...
                public void onFailure(Call<MoviesResponse> call, Throwable t) {
                    ...
                    Toast.makeText(TopRatedMovies.this, "Error Fetching Data!", Toast.LENGTH_SHORT).show();
